...
def work_with_data():
    result_list = []
    files_name = os.listdir("./project_7/data")
    files_name_list = [f"./project_7/data/page_{i}.html" for i in range(1, len(files_name) + 1)]
    ...
    with open("./project_7/result.json", "a") as file:
